...
import { ChevronDown, Trash2, Phone, MapPin } from "lucide-react";
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-brand-purple-dark/50">
                    طلب #{order.id} · {new Date(order.createdAt).toLocaleDateString("ar")}
                  </p>
                </div>
                ...
                <span className="font-bold text-brand-purple whitespace-nowrap">
                  {order.total.toLocaleString("ar")} دج
                </span>
                  ...
                  >
                    <div className="p-4 space-y-4">
                      <div className="grid sm:grid-cols-2 gap-3 text-sm">
                        ...
                        <p className="flex items-center gap-2 text-brand-purple-dark/70">
                          <MapPin size={15} /> {order.customerCity} - {order.customerAddress}
                        </p>
                      </div>
                      {order.notes && (
                      ...
                      <div className="space-y-2">
                        {order.items.map((item, i) => (
                          <div key={i} className="flex items-center gap-3">
                            ...
                            <span className="flex-1 text-sm text-brand-purple-dark truncate">{item.productNameAr}</span>
